...
#s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data ("org-elpa" ("2021-06-24 09:04:47" nil (:local-repo nil :package "org-elpa" :type git)) "melpa" ("2021-06-24 09:04:47" nil (:type git :host github :repo "melpa/melpa" :build nil :package "melpa" :local-repo "melpa")) "gnu-elpa-mirror" ("2021-06-24 09:04:47" nil (:type git :host github :repo "emacs-straight/gnu-elpa-mirror" :build nil :package "gnu-elpa-mirror" :local-repo "gnu-elpa-mirror")) "el-get" ("2021-06-24 09:04:47" nil (:type git :host github :repo "dimitri/el-get" :build nil :files ("*.el" ("recipes" "recipes/el-get.rcp") "methods" "el-get-pkg.el") :flavor melpa :package "el-get" :local-repo "el-get")) "emacsmirror-mirror" ("2021-06-24 09:04:47" nil (:type git :host github :repo "emacs-straight/emacsmirror-mirror" :build nil :package "emacsmirror-mirror" :local-repo "emacsmirror-mirror")) "straight" ("2021-06-24 09:04:47" ("emacs") (:type git :host github :repo "raxod502/straight.el" :files ("straight*.el") :branch "master" :package "straight" :local-repo "straight.el")) "use-package" ("2021-06-24 09:04:47" ("emacs" "bind-key") (:type git :flavor melpa :files (:defaults (:exclude "bind-key.el" "bind-chord.el" "use-package-chords.el" "use-package-ensure-system-package.el") "use-package-pkg.el") :host github :repo "jwiegley/use-package" :package "use-package" :local-repo "use-package")) "bind-key" ("2021-06-24 09:04:47" nil (:flavor melpa :files ("bind-key.el" "bind-key-pkg.el") :package "bind-key" :local-repo "use-package" :type git :repo "jwiegley/use-package" :host github)) "lsp-mode" ("2021-06-24 09:04:48" ("emacs" "dash" "f" "ht" "spinner" "markdown-mode" "lv") (:type git :flavor melpa :files (:defaults "clients/*.el" "lsp-mode-pkg.el") :host github :repo "emacs-lsp/lsp-mode" :package "lsp-mode" :local-repo "lsp-mode")) "dash" ("2021-06-24 09:04:48" ("emacs") (:type git :flavor melpa :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el" :package "dash" :local-repo "dash.el")) "f" ("2021-06-24 09:04:48" ("s" "dash") (:type git :flavor melpa :files ("f.el" "f-pkg.el") :host github :repo "rejeep/f.el" :package "f" :local-repo "f.el")) "s" ("2021-06-24 09:04:48" nil (:type git :flavor melpa :files ("s.el" "s-pkg.el") :host github :repo "magnars/s.el" :package "s" :local-repo "s.el")) "ht" ("2021-06-24 09:04:48" ("dash") (:type git :flavor melpa :files ("ht.el" "ht-pkg.el") :host github :repo "Wilfred/ht.el" :package "ht" :local-repo "ht.el")) "spinner" ("2021-06-24 09:04:48" ("emacs") (:type git :host github :repo "emacs-straight/spinner" :files ("*" (:exclude ".git")) :package "spinner" :local-repo "spinner")) "markdown-mode" ("2021-06-24 09:04:48" ("emacs") (:type git :flavor melpa :host github :repo "jrblevin/markdown-mode" :package "markdown-mode" :local-repo "markdown-mode")) "lv" ("2021-06-24 09:04:48" nil (:type git :flavor melpa :files ("lv.el" "lv-pkg.el") :host github :repo "abo-abo/hydra" :package "lv" :local-repo "hydra")) "lsp-ui" ("2021-06-24 09:04:48" ("emacs" "dash" "lsp-mode" "markdown-mode") (:type git :flavor melpa :files (:defaults "lsp-ui-doc.html" "resources" "lsp-ui-pkg.el") :host github :repo "emacs-lsp/lsp-ui" :package "lsp-ui" :local-repo "lsp-ui")) "typescript-mode" ("2021-06-24 09:04:48" ("emacs") (:type git :flavor melpa :host github :repo "emacs-typescript/typescript.el" :package "typescript-mode" :local-repo "typescript.el")) "php-mode" ("2021-06-24 09:04:48" ("emacs") (:type git :flavor melpa :files (:defaults "lisp/*.el" "php-mode-pkg.el") :host github :repo "emacs-php/php-mode" :package "php-mode" :local-repo "php-mode")) "vue-mode" ("2021-06-24 09:04:48" ("mmm-mode" "vue-html-mode" "ssass-mode" "edit-indirect") (:type git :flavor melpa :host github :repo "AdamNiederer/vue-mode" :package "vue-mode" :local-repo "vue-mode")) "mmm-mode" ("2021-06-24 09:04:48" ("cl-lib") (:type git :flavor melpa :host github :repo "purcell/mmm-mode" :package "mmm-mode" :local-repo "mmm-mode")) "vue-html-mode" ("2021-06-24 09:04:48" nil (:type git :flavor melpa :host github :repo "AdamNiederer/vue-html-mode" :package "vue-html-mode" :local-repo "vue-html-mode")) "ssass-mode" ("2021-06-24 09:04:48" ("emacs") (:type git :flavor melpa :host github :repo "AdamNiederer/ssass-mode" :package "ssass-mode" :local-repo "ssass-mode")) "edit-indirect" ("2021-06-24 09:04:48" ("emacs") (:type git :flavor melpa :host github :repo "Fanael/edit-indirect" :package "edit-indirect" :local-repo "edit-indirect"))))
...
(fn &rest ARGS)" nil t) (autoload 'describe-personal-keybindings "bind-key" "Display all the personal keybindings defined by `bind-key'." t nil) (register-definition-prefixes "bind-key" '("bind-key" "compare-keybindings" "get-binding-description" "override-global-m" "personal-keybindings")) (provide 'bind-key-autoloads)) "use-package" ((use-package-delight use-package-lint use-package-autoloads use-package-diminish use-package-bind-key use-package-ensure use-package-jump use-package use-package-core) (autoload 'use-package-autoload-keymap "use-package-bind-key" "Loads PACKAGE and then binds the key sequence used to invoke
...
with the specified `:load-path' the module cannot be found." t nil) (register-definition-prefixes "use-package-lint" '("use-package-lint-declaration")) (provide 'use-package-autoloads)) "dash" ((dash-autoloads dash) (autoload 'dash-fontify-mode "dash" "Toggle fontification of Dash special variables.
...
(fn &optional ARG)" t nil) (register-definition-prefixes "markdown-mode" '("defun-markdown-" "gfm-" "markdown")) (provide 'markdown-mode-autoloads)) "lv" ((lv lv-autoloads) (register-definition-prefixes "lv" '("lv-")) (provide 'lv-autoloads)) "lsp-mode" ((lsp-ocaml lsp-mode lsp-fsharp lsp-ido lsp-terraform lsp-elixir lsp-d lsp-verilog lsp-angular lsp lsp-purescript lsp-xml lsp-javascript lsp-lens lsp-completion lsp-lua lsp-vhdl lsp-nim lsp-clojure lsp-json lsp-csharp lsp-mode-autoloads lsp-modeline lsp-iedit lsp-erlang lsp-tex lsp-beancount lsp-yaml lsp-bash lsp-nix lsp-markdown lsp-racket lsp-steep lsp-r lsp-gdscript lsp-diagnostics lsp-css lsp-fortran lsp-haxe lsp-pwsh lsp-sqls lsp-dired lsp-kotlin lsp-protocol lsp-pylsp lsp-svelte lsp-pyls lsp-perl lsp-ada lsp-icons lsp-groovy lsp-solargraph lsp-php lsp-zig lsp-vimscript lsp-rf lsp-dockerfile lsp-html lsp-dhall lsp-vala lsp-go lsp-headerline lsp-crystal lsp-hack lsp-clangd lsp-eslint lsp-rust lsp-elm lsp-semantic-tokens lsp-prolog lsp-cmake lsp-sorbet lsp-vetur lsp-actionscript) (register-definition-prefixes "lsp-actionscript" '("lsp-actionscript-")) (register-definition-prefixes "lsp-ada" '("lsp-ada-")) (register-definition-prefixes "lsp-angular" '("lsp-client")) (register-definition-prefixes "lsp-bash" '("lsp-bash-")) (register-definition-prefixes "lsp-beancount" '("lsp-beancount-")) (autoload 'lsp-cpp-flycheck-clang-tidy-error-explainer "lsp-clangd" "Explain a clang-tidy ERROR by scraping documentation from llvm.org.
...
(fn FILE)" t nil) (autoload 'lsp "lsp-mode" "Entry point for the server startup.
...
(fn CLASSES)" nil nil) (register-definition-prefixes "mmm-vars" '("mmm-")) (provide 'mmm-mode-autoloads)) "vue-html-mode" ((vue-html-mode vue-html-mode-autoloads) (autoload 'vue-html-mode "vue-html-mode" "Major mode for Vue.js templates.

(fn)" t nil) (register-definition-prefixes "vue-html-mode" '("vue-html-")) (provide 'vue-html-mode-autoloads)) "ssass-mode" ((ssass-mode ssass-mode-autoloads) (autoload 'ssass-mode "ssass-mode" "Major mode for Sass

(fn)" t nil) (register-definition-prefixes "ssass-mode" '("ssass-")) (provide 'ssass-mode-autoloads)) "edit-indirect" ((edit-indirect edit-indirect-autoloads) (autoload 'edit-indirect-region "edit-indirect" "Edit the region BEG..END in a separate buffer.
...
(fn BEG END &optional DISPLAY-BUFFER)" t nil) (register-definition-prefixes "edit-indirect" '("edit-indirect-")) (provide 'edit-indirect-autoloads)) "vue-mode" ((vue-mode-autoloads vue-mode) (autoload 'vue-mode-edit-all-indirect "vue-mode" "Open all subsections with `edit-indirect-mode' in seperate windows.
...
(fn)" t nil) (setq mmm-global-mode 'maybe) (add-to-list 'auto-mode-alist '("\\.vue\\'" . vue-mode)) (register-definition-prefixes "vue-mode" '("vue-")) (provide 'vue-mode-autoloads))))

#s(hash-table size 65 test eq rehash-size 1.5 rehash-threshold 0.8125 data (org-elpa #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 9 "melpa" nil "gnu-elpa-mirror" nil "el-get" nil "emacsmirror-mirror" nil "straight" nil "use-package" nil "bind-key" nil "lsp-mode" nil "dash" nil "f" nil "s" nil "ht" nil "spinner" nil "markdown-mode" nil "lv" nil "lsp-ui" nil "typescript-mode" nil "php-mode" nil "vue-mode" nil "mmm-mode" nil "cl-lib" nil "vue-html-mode" nil "ssass-mode" nil "edit-indirect" nil)) melpa #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 2 "gnu-elpa-mirror" nil "el-get" (el-get :type git :flavor melpa :files ("*.el" ("recipes" "recipes/el-get.rcp") "methods" "el-get-pkg.el") :host github :repo "dimitri/el-get") "emacsmirror-mirror" nil "straight" nil "use-package" (use-package :type git :flavor melpa :files (:defaults (:exclude "bind-key.el" "bind-chord.el" "use-package-chords.el" "use-package-ensure-system-package.el") "use-package-pkg.el") :host github :repo "jwiegley/use-package") "bind-key" (bind-key :type git :flavor melpa :files ("bind-key.el" "bind-key-pkg.el") :host github :repo "jwiegley/use-package") "lsp-mode" (lsp-mode :type git :flavor melpa :files (:defaults "clients/*.el" "lsp-mode-pkg.el") :host github :repo "emacs-lsp/lsp-mode") "dash" (dash :type git :flavor melpa :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el") "f" (f :type git :flavor melpa :files ("f.el" "f-pkg.el") :host github :repo "rejeep/f.el") "s" (s :type git :flavor melpa :files ("s.el" "s-pkg.el") :host github :repo "magnars/s.el") "ht" (ht :type git :flavor melpa :files ("ht.el" "ht-pkg.el") :host github :repo "Wilfred/ht.el") "spinner" nil "markdown-mode" (markdown-mode :type git :flavor melpa :host github :repo "jrblevin/markdown-mode") "lv" (lv :type git :flavor melpa :files ("lv.el" "lv-pkg.el") :host github :repo "abo-abo/hydra") "lsp-ui" (lsp-ui :type git :flavor melpa :files (:defaults "lsp-ui-doc.html" "resources" "lsp-ui-pkg.el") :host github :repo "emacs-lsp/lsp-ui") "typescript-mode" (typescript-mode :type git :flavor melpa :host github :repo "emacs-typescript/typescript.el") "php-mode" (php-mode :type git :flavor melpa :files (:defaults "lisp/*.el" "php-mode-pkg.el") :host github :repo "emacs-php/php-mode") "vue-mode" (vue-mode :type git :flavor melpa :host github :repo "AdamNiederer/vue-mode") "mmm-mode" (mmm-mode :type git :flavor melpa :host github :repo "purcell/mmm-mode") "cl-lib" nil "vue-html-mode" (vue-html-mode :type git :flavor melpa :host github :repo "AdamNiederer/vue-html-mode") "ssass-mode" (ssass-mode :type git :flavor melpa :host github :repo "AdamNiederer/ssass-mode") "edit-indirect" (edit-indirect :type git :flavor melpa :host github :repo "Fanael/edit-indirect"))) gnu-elpa-mirror #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 3 "emacsmirror-mirror" nil "straight" nil "spinner" (spinner :type git :host github :repo "emacs-straight/spinner" :files ("*" (:exclude ".git"))) "cl-lib" nil)) el-get #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 1 "emacsmirror-mirror" nil "straight" nil "cl-lib" nil)) emacsmirror-mirror #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 2 "straight" (straight :type git :host github :repo "emacsmirror/straight") "cl-lib" nil))))

("org-elpa" "melpa" "gnu-elpa-mirror" "el-get" "emacsmirror-mirror" "straight" "emacs" "use-package" "bind-key" "lsp-mode" "dash" "f" "s" "ht" "spinner" "markdown-mode" "lv" "lsp-ui" "typescript-mode" "php-mode" "vue-mode" "mmm-mode" "cl-lib" "vue-html-mode" "ssass-mode" "edit-indirect")

...
Logical way of navigating between panes in a buffer, no spamming to cycle
...
Add on to this, follow when you split windows, generally how i want this to work
...
#+begin_src emacs-lisp
          (use-package php-mode
            ...
            (defun my-php-mode-init ()
              (setq-local 'company-backends '((php-mode
                                               company-yasnippet))))
#+end_src

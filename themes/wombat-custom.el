...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   ...
   `(cursor ((,class (:background "#8b8b8b"))))
   ;; Highlighting faces
   ...
   ;; Font lock faces
   `(font-lock-builtin-face ((,class (:foreground "#cae682"))))
   `(font-lock-comment-face ((,class (:foreground "#95e454"))))
   `(font-lock-constant-face ((,class (:foreground "#e5786d"))))
   `(font-lock-function-name-face ((,class (:foreground "#e5786d"))))
   `(font-lock-keyword-face ((,class (:foreground "#8ac6f2"))))
   `(font-lock-string-face ((,class (:foreground "#DCE354"))))
   `(font-lock-type-face ((,class (:foreground "#DCE354"))))
